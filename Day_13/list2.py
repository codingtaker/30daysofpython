...
print("Exercice 1: Filtrer les nombres négatifs et zéro")
...
print("Exercice 2: Aplatir une liste de listes de listes")
...
print("Exercice 5: Transformer en liste de dictionnaires")
...
print("Exercice 6: Transformer en liste de chaînes concaténées")
